...
import {MyProgressBar, MyResponsivePie } from '../helpers/charts.helper'
import "../style/donation_main.css"
import "../style/donation_smartphone.css"
import fig1 from '../img/donation_fig1.png'
...
const DonationPage = () => {
  ...
  return (
    <div id="pagebody">
      <div id="header">
        <h1 id="donation-h1">
          <div className="midlinehead">
            「北医ネット」を繋ぐために
          </div>
          <div className="midlinesubhead">
            〜運営維持のための募金のお願い〜
          </div>
        </h1>
      </div>
      <p>
        <div className="right1">「北医ネット」管理会（最終更新：2021年5月8日）
        </div>
      </p>
      <div className="container">
        <div className="row-container">
          <div className="item1">
            <div id="figure1">
              <img src={fig1} alt="husai" />
            </div>
          </div>
          <div className="item-progress">
            <div id="figure-progress">
              <MyProgressBar />
            </div>
          </div>
        </div>
        <div className="scroll_button_btm">
          <a href="#donation">今すぐ募金される方はこちら</a>
        </div>
        <div className="item">
          <p>
          ...
          <h3>募金目標金額</h3>
          <span style={{ fontSize: "160%" }}>目標：¥{donation_params.target_value.toLocaleString()}/年</span><br />
          <MyResponsivePie />
          [内訳]
        <ul>
            <li>
...
export {DonationPage, DonationValueChangePage}